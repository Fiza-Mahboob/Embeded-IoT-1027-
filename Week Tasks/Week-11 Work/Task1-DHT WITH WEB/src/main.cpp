...
#define BLYNK_TEMPLATE_ID "TMPL6oeKM4ajS"
#define BLYNK_TEMPLATE_NAME "DHT 1027"
#define BLYNK_AUTH_TOKEN "8kUrLK-nJQ6ow9CEAlAFXkop1Bcru6XX  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
